...
AuthorSchema
    ...
    .get(function () {
        ...
        return (this.date_of_death && this.date_of_death ? (this.date_of_death.getYear() - this.date_of_birth.getYear()).toString() : "Lifespan information missing");
    });
...
// Virtual for form formatted date of birth
AuthorSchema
...
// Virtual for form formatted date of death
AuthorSchema
